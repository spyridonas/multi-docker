...
class EmailController extends AbstractController
{
    ...
    #[Route('/{email_id}', name: 'app_email_show', methods: ['GET'])]
    ...
    #[Route('/{email_id}/edit', name: 'app_email_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{email_id}', name: 'app_email_delete', methods: ['POST'])]
    public function delete(Request $request, Email $email, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$email->getEmail_id(), $request->request->get('_token'))) {
